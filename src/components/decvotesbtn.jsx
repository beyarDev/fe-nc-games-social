...
export default function DecVotesBtn({reviewID, setSingleReview, setReviewList, setDisableInc, disableDec, setDisableDec, setReviewByCategory}){
    function incVotes(){
    ...
    return <button onClick={incVotes} style={incBtnStyle} disabled={disableDec}><BiDownvote style={{height:'100%', width:'100%'}}/></button>
}