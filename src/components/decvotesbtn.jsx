...
export default function DecVotesBtn({reviewID, setSingleReview, setReviewList}){
    function incVotes(){
    ...
    return <button onClick={incVotes} style={incBtnStyle}><BiDownvote style={{height:'100%', width:'100%'}}/></button>
}